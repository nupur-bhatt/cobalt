...
var useCreate = function (resource, params, options) {
    ...
    var dataProviderCreate = (0, util_1.useEvent)(function (resource, params) {
        return dataProvider.create(resource, params);
    });
    var _b = (0, useMutationWithMutationMode_1.useMutationWithMutationMode)(__assign({ resource: resource }, params), __assign(__assign({}, mutationOptions), { mutationKey: [resource, 'create', params], mutationMode: mutationMode, mutationFn: function (_a) {
    ...
    var create = (0, util_1.useEvent)(function (callTimeResource, callTimeParams, callTimeOptions) {
