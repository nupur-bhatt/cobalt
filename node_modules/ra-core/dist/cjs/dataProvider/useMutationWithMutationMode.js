...
var useMutationWithMutationMode = function (params, options) {
    ...
    var mutationFnEvent = (0, util_1.useEvent)(mutationFn);
    var updateCacheEvent = (0, util_1.useEvent)(updateCache);
    var getSnapshotEvent = (0, util_1.useEvent)(getSnapshot);
