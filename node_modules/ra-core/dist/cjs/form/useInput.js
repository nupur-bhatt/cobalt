...
var useInput = function (props) {
    ...
    var formGroupName = (0, groups_1.useFormGroupContext)();
    var formGroups = (0, groups_1.useFormGroups)();
    ...
    var _c = (0, react_hook_form_1.useController)(__assign({ name: finalName, defaultValue: (0, get_1.default)(record, finalSource, defaultValue), rules: {
