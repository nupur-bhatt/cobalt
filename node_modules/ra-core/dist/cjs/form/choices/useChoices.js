...
var useChoices = function (_a) {
    ...
    var getChoiceText = (0, react_1.useCallback)(function (choice) {
        if ((choice === null || choice === void 0 ? void 0 : choice.id) === createValue || (choice === null || choice === void 0 ? void 0 : choice.id) === createHintValue) {
            return (0, get_1.default)(choice, typeof optionText === 'string' ? optionText : 'name');
        }
    ...
    var getChoiceValue = (0, react_1.useCallback)(function (choice) { return (0, get_1.default)(choice, optionValue, (0, get_1.default)(choice, 'id')); }, [optionValue]);
    var getDisableValue = (0, react_1.useCallback)(function (choice) { return (0, get_1.default)(choice, disableValue); }, [disableValue]);
    return {
