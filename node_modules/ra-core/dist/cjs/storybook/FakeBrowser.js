...
var Browser = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "browser" },
            React.createElement(BrowserBar, null),
...
var BrowserBar = function () {
    ...
    var fullLocation = "".concat(location.pathname).concat(location.search).concat(location.hash);
    var handleSubmit = function (event) {
        event.preventDefault();
        var newLocation = event.target.elements.location.value.replace('http://localhost:3000', '');
    ...
    return (React.createElement("div", { className: "browser-bar" },
        ...
        React.createElement("form", { onSubmit: handleSubmit },
            React.createElement("input", { name: "location", type: "text", key: fullLocation, defaultValue: "http://localhost:3000".concat(fullLocation) }))));
};
