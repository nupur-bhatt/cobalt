...
var ListBase = function (_a) {
    var children = _a.children, emptyWhileLoading = _a.emptyWhileLoading, authLoading = _a.authLoading, loading = _a.loading, offline = _a.offline, error = _a.error, render = _a.render, props = __rest(_a, ["children", "emptyWhileLoading", "authLoading", "loading", "offline", "error", "render"]);
    ...
    var showEmpty = isPending && !showOffline && emptyWhileLoading === true;
    return (
