 ...
 * );
 */
export declare const ListBase: <RecordType extends RaRecord = any>({ children, emptyWhileLoading, authLoading, loading, offline, error, render, ...props }: ListBaseProps<RecordType>) => React.JSX.Element;
