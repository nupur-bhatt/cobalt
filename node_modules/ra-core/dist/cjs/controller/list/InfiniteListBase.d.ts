 ...
 * );
 */
export declare const InfiniteListBase: <RecordType extends RaRecord = any>({ authLoading, loading, offline, error, children, render, ...props }: InfiniteListBaseProps<RecordType>) => React.JSX.Element;
