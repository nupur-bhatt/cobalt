...
var useList = function (props) {
    ...
    var _l = (0, react_1.useState)(function () { return ({
        data: data,
        total: data ? data.length : undefined,
    }); }), finalItems = _l[0], setFinalItems = _l[1];
    // pagination logic
    var _m = (0, usePaginationState_1.default)({
        page: initialPage,
        perPage: initialPerPage,
    }), page = _m.page, setPage = _m.setPage, perPage = _m.perPage, setPerPage = _m.setPerPage;
    // sort logic
    var _o = (0, useSortState_1.default)(initialSort), sort = _o.sort, setSortState = _o.setSort;
    var setSort = (0, react_1.useCallback)(function (sort) {
        setSortState(sort);
        setPage(1);
    }, [setPage, setSortState]);
    // selection logic
    var _p = (0, useRecordSelection_1.useRecordSelection)(resource
        ? {
            resource: resource,
        }
    ...
    var _q = (0, react_1.useState)({}), displayedFilters = _q[0], setDisplayedFilters = _q[1];
    var _r = (0, react_1.useState)(filter), filterValues = _r[0], setFilterValues = _r[1];
