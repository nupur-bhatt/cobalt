...
var useReferenceOneFieldController = function (props) {
    var reference = props.reference, target = props.target, _a = props.source, source = _a === void 0 ? 'id' : _a, _b = props.sort, sort = _b === void 0 ? { field: 'id', order: 'ASC' } : _b, _c = props.filter, filter = _c === void 0 ? {} : _c, _d = props.queryOptions, queryOptions = _d === void 0 ? {} : _d;
    ...
    var _e = (0, dataProvider_1.useGetManyReference)(reference, {
        ...
        } }, otherQueryOptions)), data = _e.data, error = _e.error, isFetching = _e.isFetching, isLoading = _e.isLoading, isPaused = _e.isPaused, isPending = _e.isPending, isPlaceholderData = _e.isPlaceholderData, refetch = _e.refetch;
    return {
