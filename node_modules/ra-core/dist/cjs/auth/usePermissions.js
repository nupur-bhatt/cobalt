...
var usePermissions = function (params, queryParams) {
    ...
    var queryResult = (0, react_query_1.useQuery)(__assign({ queryKey: ['auth', 'getPermissions', params], queryFn: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            var permissions;
